...
//    public Reservation(int reservationId, int patientId, int clinicId, int appId, Date reservationDate, java.sql.Date appointmentDate, int patientNum, int isConsultaion) {
